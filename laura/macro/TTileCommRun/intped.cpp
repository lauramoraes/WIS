...
#define standOutputDir  "/afs/cern.ch/user/t/tilecom/public/www/WIS/results/team5/integrator/";
...
void ntread( const char *filename, Int_t t_low, Int_t t_high, Int_t level, Int_t mincounts,Int_t maxcounts)
{
	...
	TString inputfile = "root://tilebeam@pcata007.cern.ch//work/commissioning/team4/integrator/offline/" + TString(moduleName)+"/"+TString(filename)+TString(".root");
