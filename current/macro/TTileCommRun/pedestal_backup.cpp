...
const Int_t MAXEVT_FOR_2D=100000;
		...
		/*********Some definitions**************/
const TString outputDir = "/home/httpd/html/tile/info/lps/WIS/results/team5/pedestal/";
const TString standOutputDir = "/afs/cern.ch/user/t/tilebeam/scratch0/Commissioning/results/team5/pedestal/";
const TString outputWebDir = "http://tileinfo.web.cern.ch/tileinfo/lps/WIS/results/team5/pedestal/";
...
void pedplots(TString runno, TString filename, TString module, TWISMacroResult & results)
{
  ...
  */
  ...
  TString filenameps = outputDir +"r"+runno+"_"+module+"_Ped_v2.ps";
  TString filenamepng =outputDir +"r"+runno+"_"+module+"_Ped_v2.png";
  cped->Print(filenameps);
  cped->Print(filenamepng);

  TString plotFilename= outputWebDir + "r"+runno+"_"+module+"_Ped_v2.png";
  TString plotPsFilename= outputWebDir + "r"+runno+"_"+module+"_Ped_v2.ps";
  ...
  filenamepng = outputDir + "expert/r" + runno + "_" + module + "_Ped_Expert_PedHi1-24.png";
  c1->Print(filenamepng);
  filenamepng = outputDir + "expert/r" + runno + "_" + module + "_Ped_Expert_PedHi25-48.png";
  c5->Print(filenamepng);
  
  filenamepng = outputDir + "expert/r" + runno + "_" + module + "_Ped_Expert_PedLo1-24.png";
  c2->Print(filenamepng);
  filenamepng = outputDir + "expert/r" + runno + "_" + module + "_Ped_Expert_PedLo25-48.png";
  c6->Print(filenamepng);
  
  filenamepng = outputDir + "expert/r" + runno + "_" + module + "_Ped_Expert_PedTimeHi1-24.png";
  c3->Print(filenamepng);
  filenamepng = outputDir + "expert/r" + runno + "_" + module + "_Ped_Expert_PedTimeHi25-48.png";
  c7->Print(filenamepng);
  
  filenamepng = outputDir + "expert/r" + runno + "_" + module + "_Ped_Expert_PedTimeLo1-24.png";
  c4->Print(filenamepng);
  filenamepng = outputDir + "expert/r" + runno + "_" + module + "_Ped_Expert_PedTimeLo25-48.png";
  c8->Print(filenamepng);
  
  completeModuleName = "LB" + module;

  // Saving plots to Results Database (TileComm Analysis)
  TString plot1 = outputWebDir + "expert/r"+runno+"_"+module+"_Ped_Expert_PedHi1-24.png";
  wis2Tilecomm(runno.Data(), completeModuleName.Data(), plot1.Data(), results);

  TString plot2 = outputWebDir + "expert/r"+runno+"_"+module+"_Ped_Expert_PedHi25-48.png";
  wis2Tilecomm(runno.Data(), completeModuleName.Data(), plot2.Data(), results);

  TString plot3 = outputWebDir + "expert/r"+runno+"_"+module+"_Ped_Expert_PedLo1-24.png";
  wis2Tilecomm(runno.Data(), completeModuleName.Data(), plot3.Data(), results);

  TString plot4 = outputWebDir + "expert/r"+runno+"_"+module+"_Ped_Expert_PedLo25-48.png";
  wis2Tilecomm(runno.Data(), completeModuleName.Data(), plot4.Data(), results);

  TString plot5 = outputWebDir + "expert/r"+runno+"_"+module+"_Ped_Expert_PedTimeHi1-24.png";
  wis2Tilecomm(runno.Data(), completeModuleName.Data(), plot5.Data(), results);

  TString plot6 = outputWebDir + "expert/r"+runno+"_"+module+"_Ped_Expert_PedTimeHi25-48.pn";
  wis2Tilecomm(runno.Data(), completeModuleName.Data(), plot6.Data(), results);

  TString plot7 = outputWebDir + "expert/r"+runno+"_"+module+"_Ped_Expert_PedTimeLo1-24.pn";
  wis2Tilecomm(runno.Data(), completeModuleName.Data(), plot7.Data(), results);

  TString plot8 = outputWebDir + "expert/r"+runno+"_"+module+"_Ped_Expert_PedTimeLo25-48.png";
