...
<script type="text/javascript">
	...
	#legenda { position: fixed; bottom: 0; left: 0; width: 400px; }

	#comentBox {position: fixed; bottom: 0; right: 0; width:300px;}
</style>
</head>
<body onLoad="getDate();">
<CENTER>
...
<BR>
<A href='http://atlas-php.web.cern.ch/atlas-php/NOVA/TBAnalysis/TileCommAnalysis/version1.3/searchResult.php?runNumber=<?echo $runNumber;?>' target="_blank">See Plots or Edit Comments</A><br><br><br><br><br><br><br><br><br>
</CENTER>
<div style='position:fixed;bottom:0px;right:0px;width:300px;' id='commentBox' name='commentBox'>
